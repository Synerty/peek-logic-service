...
def upgrade():
    ...
    op.create_index('idx_PeekAppInfo_NameVersion', 'PeekAppInfo', ['name', 'version'], unique=True, schema='peek_server')
...
def downgrade():
    ...
    op.drop_index('idx_PeekAppInfo_NameVersion', table_name='PeekAppInfo', schema='peek_server')
    op.drop_table('PeekAppInfo', schema='peek_server')
    ### end Alembic commands ###
