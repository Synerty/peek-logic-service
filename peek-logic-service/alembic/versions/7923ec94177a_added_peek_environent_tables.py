...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['serverId'], ['peek_logic_service.PeekEnvServer.id'], ),
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('PeekEnvWorker', schema='peek_logic_service')
    op.drop_table('PeekEnvClient', schema='peek_logic_service')
    op.drop_table('PeekEnvAgent', schema='peek_logic_service')
    op.drop_table('PeekEnvServer', schema='peek_logic_service')
    ### end Alembic commands ###
