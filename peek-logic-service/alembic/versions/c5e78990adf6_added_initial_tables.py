...
def upgrade():
    ...
    op.create_index('idx_PeekPluginInfo_NameVersion', 'PeekPluginInfo', ['name', 'version'], unique=True, schema='peek_logic_service')
    ...
    sa.ForeignKeyConstraint(['settingId'], ['peek_logic_service.Setting.id'], ),
    sa.PrimaryKeyConstraint('id', 'settingId', 'key'),
    schema='peek_logic_service'
    )
    op.create_index('idx_SettingProperty_settingId', 'SettingProperty', ['settingId'], unique=False, schema='peek_logic_service')
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_SettingProperty_settingId', table_name='SettingProperty', schema='peek_logic_service')
    op.drop_table('SettingProperty', schema='peek_logic_service')
    op.drop_table('Setting', schema='peek_logic_service')
    op.drop_index('idx_PeekPluginInfo_NameVersion', table_name='PeekPluginInfo', schema='peek_logic_service')
