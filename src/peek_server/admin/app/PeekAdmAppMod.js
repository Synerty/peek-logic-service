...
define([
    ...
    var peekAdmAppCtrlMod = angular_1.angular.module('peekAdmAppCtrlMod', []);
    var peekAdminApp = angular_1.angular.module('peekAdminApp', ['rapuiMod', 'ngRoute',
        'ui.bootstrap',
    ...
    $(function () {
        angular_1.angular.bootstrap(document, ["peekAdminApp"]);
    });
    // --------------------- Angular Application----------------------------
